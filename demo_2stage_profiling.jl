...
runtime = @elapsed phi,xi,lamb, W, Wlen, all_objs,all_obj_times, stages,Wlen_list,searching_times,pow_times,f_evals_list, L_list, optimization_starting_steps = 
two_stage_active_set_profiling(Xmat,Y,rho;
    verbose = verbose,random_state=random_state, maxiter=maxiter, maxtime=maxtime, block=block, dropzero=dropzero,  params_list = [params1, params2], augs = [aug1, aug2]);
